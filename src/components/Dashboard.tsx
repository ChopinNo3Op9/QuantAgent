...
import { 
  ...
  ShieldAlert, Settings2, BarChart3, Clock, DollarSign
} from 'lucide-react';
import {
...
function generateBacktestData(action: string) {
  ...
  for (let i = 0; i <= 60; i++) {
    ...
    const drift = isBuy ? 0.001 : (isSell ? -0.001 : 0);
    ...
    // Let's assume it goes long if BUY, or short if SELL.
            ...
            <div className="bg-zinc-950 border border-zinc-800 rounded-2xl shadow-xl overflow-hidden p-6">
              ...
              <div className="h-72 w-full">
                <ResponsiveContainer width="100%" height="100%">
                  <LineChart data={backtestData} margin={{ top: 5, right: 0, left: -20, bottom: 0 }}>
